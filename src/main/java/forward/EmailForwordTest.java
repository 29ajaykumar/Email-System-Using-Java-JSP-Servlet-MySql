...
//
//    public void emailForwordTest(String forwardedText, String emailNo, String forwardEmail,final String username,final String password) {
...
//                    InternetAddress.parse(forwardEmail));
//
...
//        final String receiverEmail = "ajaykumar.bhumca2015@gmail.com";
//       EmailForwordTest obj =  new EmailForwordTest();
//       obj.emailForwordTest("Forwarded Email Text by ajay.","1","ajaykumar.bhumca2015@gmail.com");
    }
}
